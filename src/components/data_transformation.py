...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        Raises:
            CustomException: Raises exception using custom exception imported from src.CustomException

        Returns:
            ColumnTransformer: Preprocessor object for transforming data
        """
        try:
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            logging.info(
                "Applying preprocessor object on train and test dataset")
